...
/**
 * This is a unit test, which verifies logic in BiologicalOrderService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class BiologicalOrderServiceTest {
	
	@InjectMocks
	BiologicalOrderServiceImpl basicModuleService;
