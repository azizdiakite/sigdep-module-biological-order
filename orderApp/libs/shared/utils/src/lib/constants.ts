...
export const manageReportPrivileges: string[] = [
 ...
 // const LAST_VIRAL_LOAD = "163545AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
  ...
  const LAST_VIRAL_LOAD = "165270AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
  ...
  const LAST_VIRAL_LOAD_LABORATORY = "165271AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
...
// f4503ae0-c285-4f69-b1f6-f61f942dd655
